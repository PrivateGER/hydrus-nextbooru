...
const CATEGORY_BG_COLORS: Record<TagCategory, string> = {
  [TagCategory.ARTIST]: "bg-red-900/30 border-red-800/50",
  [TagCategory.COPYRIGHT]: "bg-purple-900/30 border-purple-800/50",
  [TagCategory.CHARACTER]: "bg-green-900/30 border-green-800/50",
  [TagCategory.GENERAL]: "bg-blue-900/30 border-blue-800/50",
  [TagCategory.META]: "bg-orange-900/30 border-orange-800/50",
};
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-zinc-100">Popular Tags</h2>
        <Link
          href="/tags"
                ...
                {categoryTags.slice(0, 8).map((tag) => (
                  <li key={tag.id}>
                    ...
                    >
                      ...
                      <span className="ml-2 shrink-0 text-xs text-zinc-500 group-hover:text-zinc-400">
